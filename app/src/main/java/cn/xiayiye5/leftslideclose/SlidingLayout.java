...
public class SlidingLayout extends FrameLayout {
    ...
    private boolean canScrollFinish = true;
    ...
    public boolean isCanScrollFinish() {
        return canScrollFinish;
    }

    public void setCanScrollFinish(boolean canScrollFinish) {
        this.canScrollFinish = canScrollFinish;
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                boolean isFastScroll = (System.currentTimeMillis() - touchTime) < 300;
                int percent = 2;
                //快速滑动 1/10的屏幕宽度即可 慢速一半宽度
                percent = isFastScroll ? 10 : 2;
                // 根据手指释放时的位置决定回弹还是关闭
                if (-getScrollX() < getWidth() / percent) {
                    scrollBack();
                } else {
                    scrollClose();
                }
